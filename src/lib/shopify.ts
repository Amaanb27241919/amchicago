...
const SHOPIFY_STORE_PERMANENT_DOMAIN = '4bf27b.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'a03f9740919def5968c329e6f748c473';
...
export async function createStorefrontCheckout(items: Array<{ variantId: string; quantity: number }>): Promise<string> {
  try {
    ...
    // Redirect back to thank-you page after checkout completion
    url.searchParams.set('return_to', `${window.location.origin}/thank-you`);
    return url.toString();
  } catch (error) {
